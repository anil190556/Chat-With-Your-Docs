...
A retrieval-augmented generation (RAG) system that lets you upload documents (PDF, TXT, MD, DOCX) and ask natural-language questions answered with citations from your own content.
...
git clone https://github.com/your-org/docchat
cd docchat
pnpm install
